...
class ModelCatalog final : public QObject {
  ...
  private:
    ...
    struct Artifact {
        QString id, version, model_digest, runtime_digest, github_url, hugging_face_url;
        int training_step = 0, training_simulations = 0;
    ...
    void addArtifact(const QString& source, const QJsonObject& metadata, const QString& webUrl);
    ...
    int busy_count_ = 0;
    QString download_id_, download_staging_, download_destination_, download_error_;
